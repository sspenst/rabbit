  ...
  return (
    ...
    >
      ...
      <div className='fixed inset-0 flex w-screen items-center justify-center p-4'>
        <DialogPanel className='w-full max-w-fit px-6 py-4 my-8 overflow-hidden text-left align-middle transition-all transform shadow-xl rounded-xl border border-neutral-300 dark:border-neutral-700 flex flex-col gap-4 bg-white dark:bg-black'>
          <DialogTitle as='h3' className='text-xl font-bold text-center'>
            Help
          </DialogTitle>
